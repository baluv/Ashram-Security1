...
<body>
<br/>
<c:url var="getReport" value="/security/getG4SSecurityReportpdf.html"></c:url>
...
<input type="hidden" name="toDate" value="${toDate}"/>
  ...
  <div align="right"><a href="/getG4SSecurityReportpdf.html" target="_blank"><input type="submit" value="getPdfReport" style="height:25px; width:100px"/></a></div> 
<div id="container1">
 <div id="page1">
    <div id="dt_example">
        <div id="container">
