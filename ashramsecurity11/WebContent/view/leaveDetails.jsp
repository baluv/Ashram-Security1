 ...
 <div id="page1">
    <div id="dt_example">
          ...
          <table id="employee" class="display">
             <thead>
                  ...
                  <th align="left">Employee Id</th>
                      ...
                      <th align="left">Emp_Dept</th>
                      
                      <th align="left">LeaveFromDate</th>
                       <th align="left">LeaveToDate</th>
                      <th align="left">LeaveType</th>
                     <th align="left">Contact_Num</th>
        ...
        <tr style="cursor:pointer" onmouseover="this.background='#C0C0C0'" ">
          ...
          <td><c:out value="${item.fromdate}"></c:out></td>
           <td><c:out value="${item.todate}"></c:out></td>
            <td><c:out value="${item.leavetype}"></c:out></td>
            <td><c:out value="${item.number_duringleave}"></c:out></td>
